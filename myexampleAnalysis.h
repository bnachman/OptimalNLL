...
class myexampleAnalysis{
	...
	float fTJsmallN[MaxNJetSmallR];
	float fTJsmallSquirrel[MaxNJetSmallR];
	int fTJsmallTrackMult[MaxNJetSmallR];
	int fTJsmallISD[MaxNJetSmallR];
	float fTJsmallSquirrel_many[MaxNJetSmallR][15];
	...
	float            fTJsmallD2_b1         [MaxNJetSmallR];
	float            fTJsmallD2_b2         [MaxNJetSmallR];
